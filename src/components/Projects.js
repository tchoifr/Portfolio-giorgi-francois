...
export const Projects = () => {
  ...
  return (
    <section className="project" id="project">
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  <Nav variant="pills" className="nav-pills mb-5 justify-content-center align-items-center" id="pills-tab">
                    <Nav.Item>
                      <Nav.Link eventKey="first">Mes projets Professionnels</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="second">Mes projets Scolaires</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
      ...
      <img className="background-image-right" src={colorSharp2} alt="background formation et projet"></img>
    </section>
  )
}
